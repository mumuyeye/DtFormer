...
foggy_driving_data_root = f'{all_data_root}/03-Final_Foggy_Driving_for_train/FD'
...
data = dict(
    ...
    val=dict(
        type='FoggyDrivingFineDataset', # FDD
        data_root=foggy_driving_data_root,
        img_dir='img',
        ann_dir='gt/labelTrainIds',
        pipeline=test_pipeline),
    test=dict(
        type='FoggyDrivingFineDataset',
        data_root=foggy_driving_data_root,
        img_dir='img',
        ann_dir='gt/labelTrainIds',
        pipeline=test_pipeline))
