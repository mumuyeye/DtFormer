...
from tools.segment_anything.modeling import Sam

from mmseg.core import add_prefix
from mmseg.ops import resize
from tools.segment_anything.utils.transforms import ResizeLongestSide
from .. import builder
...
class SAMEncoderDecoder(BaseSegmentor):
    def __init__(self,
                 backbone,
                 neck,
                 decode_head,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(SAMEncoderDecoder, self).__init__(init_cfg)
    ...
    def extract_feat(self, img):
        ...
        x = self.backbone(img)  # [B, 64, 256, 256]
        sparse_embeddings, dense_embeddings, dense_pe = self.neck()
        embeddings = {'image_embeddings': x,
                      'image_pe': dense_pe,
    ...
    def encode_decode(self, img, img_metas, return_feat=False):
        ...
        # TODO: get the list of binary segments
