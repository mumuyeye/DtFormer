...
class ResNetV1c(ResNet):
    ...
    in the input stem with three 3x3 conv s.
...
class ResNetV1d(ResNet):
    ...
    the input stem with three 3x3 conv. And in the down-sampling block, a 2x2
...
class ResNetLW(ResNet):
    ...
    """
    def __init__(self, **kwargs):
        super(ResNetLW, self).__init__(deep_stem=False, avg_down=False, **kwargs)
