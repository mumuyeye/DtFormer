...
from mmseg.models.segmentors.hrda_encoder_decoder import HRDAEncoderDecoder
from mmseg.models.uda.compare.aux_modules.fcdiscriminator import FCDiscriminator
...
@UDA.register_module()
class AdaptSegNet(UDADecorator):
    def __init__(self, **cfg):
        super(AdaptSegNet, self).__init__(**cfg)
        self.local_iter = 0
        self.num_classes = cfg['model']['decode_head']['num_classes']
        self.max_iters = cfg['max_iters']
        self.lr_D = cfg['lr_D_params']['lr']
        self.lr_D_power = cfg['lr_D_params']['power']
        self.lr_D_min = cfg['lr_D_params']['min']
