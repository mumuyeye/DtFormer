...
from mmseg.models.uda.uda_modules.masking_consistency_module import \
...
@UDA.register_module()
class MIC(UDADecorator):

    def __init__(self, **cfg):
        super(MIC, self).__init__(**cfg)
        self.local_iter = 0
    ...
    def forward_train(self,
        ...
        if self.local_iter % self.debug_img_interval == 0 and \
            ...
            out_dir = os.path.join(self.train_cfg['base_work_dir'], 'debug')
