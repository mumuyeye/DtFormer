...
def parse_args(args):
    ...
    parser.add_argument('--config', help='train config file path',
                        default='/home/gis/wzq/code/0-experiment-platform/configs/daformer/cs2acdc_uda_medium_warm_rcs_croppl_a999_transweather_multitask_mitb5_s0.py')
    parser.add_argument('--work-dir', help='the dir to save logs and models',
                        default='/home/gis/wzq/code/0-experiment-platform/work_dirs/debug')
    parser.add_argument(
...
def main(args):
    ...
    # snapshot source code
    gen_code_archive(cfg.base_work_dir)
    # init the logger before other steps
    timestamp = time.strftime('%Y%m%d_%H%M%S', time.localtime())
    log_file = osp.join(cfg.base_work_dir, f'{timestamp}.log')
