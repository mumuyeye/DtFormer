...
config_path = '/hy-tmp/DAFormer/configs/daformer/supervised.py'
load_from = '/hy-tmp/0-experiment-platform/work_dirs/my_methods/cudaformer/fog/acdc_12500/iter_40000.pth'
debug_path = '/hy-tmp/DAFormer/work_dirs/debug'
