...
class ModuleWithRecordsAndReducer(ModuleWithRecords, ABC):
...
class ModuleWithRecordsAndDistance(ModuleWithRecords, ABC):
...
class ModuleWithRecordsReducerAndDistance(
    ModuleWithRecordsAndReducer, ModuleWithRecordsAndDistance, ABC
):
