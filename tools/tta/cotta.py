...
cfg_path = '/hy-tmp/0-experiment-platform/configs/TTA/segformer.b5.1024x1024.acdc.160k.py'
load_from = '/hy-tmp/0-experiment-platform/pretrained/tta/segformer.b5.1024x1024.city.160k.pth'
